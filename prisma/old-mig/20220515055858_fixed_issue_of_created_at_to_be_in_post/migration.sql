...
INSERT INTO "new_Post" ("articleUrl", "authorId", "category", "content", "created_at", "id", "imageUrl", "podcastTitle", "podcastUrl", "published", "title") SELECT "articleUrl", "authorId", "category", "content", "created_at", "id", "imageUrl", "podcastTitle", "podcastUrl", "published", "title" FROM "Post";
DROP TABLE "Post";
